...
class RateKeeper(object):
    ...
    def callInteract(self):
        ...
        dt = _clock() - t
        if self.count == 1:
            self.renderTime = 0.005  # first value is abnormal; make small nonzero
        elif self.count == 2:
            self.renderTime = dt  # we now have a measure of actual loop render time
